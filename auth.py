...
class Auth:
    def __init__(self, email, password, appcheck_token=None):
        self.email = email
        self.password = password
        self.device_id = self.generate_device_id()
        self.token = None
        # Get AppCheck token from parameter or environment variable
        self.appcheck_token = appcheck_token or os.getenv("FIREBASE_APPCHECK_TOKEN", "")
